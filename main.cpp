...
int main(void)
{
    ...
    while (1)
    {
        ...
        const float v = sqrt(pow(odom_ptr->getTwist()[0], 2) + pow(odom_ptr->getTwist()[1], 2)) * (odom_ptr->getTwist()[1] / abs(odom_ptr->getTwist()[1]));
        printf("v : %10.6f omega: %10.6f\r\n", v, odom_ptr->getTwist()[2]);
        // printf("vx : %10.6f vy : %10.6f omega: %10.6f\r\n", odom_ptr->getTwist()[0], odom_ptr->getTwist()[1], odom_ptr->getTwist()[2]);
