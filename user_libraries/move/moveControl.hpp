...
class moveControl {
 public:
  moveControl(std::shared_ptr<odometry> _odom_ptr) : odom_ptr(_odom_ptr), motor1(D5, D6), motor2(PE_12, PE_14)
  {
    motor1.setPeriod(0.0001);
    motor2.setPeriod(0.0001);
  };
  moveControl() : odom_ptr(nullptr), motor1(D5, D6), motor2(PE_12, PE_14)
  {
    motor1.setPeriod(0.0001);
    motor2.setPeriod(0.0001);
  };
